...
port=process.env.EMAIL_PASSWORD_AUTHENTICATOR_PORT ? process.env.PORT ?3003 
app = express()
...
#    console.error 'meshbl-authenticator-email-password requires privateKey'
#    process.exit 1
#
  meshbluHttp.setPrivateKey meshbluJSON.privateKey
